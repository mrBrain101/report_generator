...
Скрипт для чтения файлов с данными, передаваемыми через командную строку, и формирования отчетов.

Скриншоты примеров запуска:
<details>
...
Реализовано тестирование с использованием библиотеки PyTest.<br>
Запуск тестирования описан в разделе [Установка, использование и примеры запуска](#установка-использование-и-примеры-запуска).
...
- Для выхода из консоли и остановки Docker-контейнера используйте команду `exit`.
...
- При изменении структуры CSV-файлов, необходимо внести изменения в модель данных `src/data_processing/data_model.py`;
- При добавлении новых типов файлов, необходимо добавить класс для нового типа данных с наследованием от `ArgumentProcessor` в модуле `src/data_processing/data_processing.py` и при необходимости внести изменения в модель данных `src/data_processing/data_model.py`.
